	...
	ActTab:function(){
		jQuery("#dorTabLists2 > li a").click(function(){
			...
			if(jQuery.trim(checkExist).length == 0 || checkExist == undefined){
				...
				jQuery("#dorTabListCategoryContent2").css("min-height","330px");
				...
				jQuery.ajax({
		            ...
		            success:function(data){
		            	setTimeout(function(){
			            	...
			            	var objIDElement = "#dor-tab-list-category2 #cate-tab-list2-"+idObj+" .product_list";
			            	DORTHEME.TablistAjaxCarousel(objIDElement);
