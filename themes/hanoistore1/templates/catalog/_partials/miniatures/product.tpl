 ...
 *}
<article class="product-miniature js-product-miniature ajax_block_product col-xs-12 col-sm-6 col-md-4{if isset($dorCategoryShow) && $dorCategoryShow == 'list'} dor-list-display{/if}" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
    ...
    <div class="right-block">
      <div class="dor-product-description">
        ...
        {block name='product_description_short'}
          <div id="product-description-short" class="hidden" itemprop="description">{$product.description_short nofilter}</div>
        {/block}
      </div>
    </div>
