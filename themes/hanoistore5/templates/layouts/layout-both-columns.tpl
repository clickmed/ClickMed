    ...
    <main{if isset($dorlayoutmode) && $dorlayoutmode != ""} class="{$dorlayoutmode}"{/if}>
      ...
      {if $page.page_name == 'index'}
        ...
        {if $smarty.capture.dorDailyDeal || $smarty.capture.dorSidebar2}
          <div class="dorLayoutGroupMode blockPosition dor-bg-gray">
            <div class="container">
              <div class="row">
        ...
        {if $smarty.capture.blockDorado2}
          <div class="blockDorado2 blockPosition dor-bg-gray">
            <div class="container">
              <div class="row">
      ...
      {if $page.page_name == 'index'}
            ...
            {if $smarty.capture.tablistcategory1}
              <div class="tablistcategory1 blockPosition dor-bg-gray">
                <div class="container">
                  <div class="row">
            ...
            {if $smarty.capture.tablistcategory2}
              <div class="tablistcategory2 blockPosition dor-bg-gray">
                <div class="container">
                  <div class="row">
            ...
            {if $smarty.capture.tablistcategory3}
              <div class="tablistcategory3 blockPosition dor-bg-gray">
                <div class="container">
                  <div class="row">
          ...
          {if $smarty.capture.blockDorado4}
            <div class="blockDorado4 blockPosition dor-bg-gray">
              <div class="container">
                <div class="row">
      ...
      {if $page.page_name == 'index'}
          ...
          {if $smarty.capture.DorTestimonial}
            <div class="DorTestimonial blockPosition dor-bg-gray">
              <div class="container">
                <div class="row">
        ...
        {/if}
      {if $page.page_name == 'index'}
          {capture name='dorAjaxTabPro3'}{hook h='dorAjaxTabPro3'}{/capture}
          {if $smarty.capture.dorAjaxTabPro3}
            <div class="dorAjaxTabPro3 blockPosition dor-bg-gray">
              <div class="container">
                <div class="row">
                {$smarty.capture.dorAjaxTabPro3 nofilter}
                </div>
              </div>
            </div>
          {/if}
          ...
          {if $smarty.capture.DorHomeLatestNews}
            <div class="DorHomeLatestNews blockPosition dor-bg-gray">
              <div class="container">
                <div class="row">
          ...
          {if $smarty.capture.blockDorado9}
            <div class="blockDorado9 blockPosition dor-bg-gray">
              <div class="container">
                <div class="row">
