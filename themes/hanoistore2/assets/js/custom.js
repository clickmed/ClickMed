...
var DORTHEME = {
	...
	EventSite:function(){
		jQuery(".head-tab-lists > h3 > i").click(function(){
			jQuery(this).closest(".dor-tab-list-category-wrapper").find(".list-category-fil").slideToggle(200,function(){})
		});
