...
{if $dorslider.slides}
  <div id="dorSlideShow" class="homeslider-container" data-interval="{$dorslider.speed}" data-wrap="{$dorslider.wrap}" data-pause="{$dorslider.pause}" data-arrow={$dorslider.arrow} data-nav={$dorslider.nav}>
    <div id="top_column" class="center_column col-xs-12 col-sm-12">
      <div class="row">
      <div id="Dor_Full_Slider" style="width: 1300px; height: 641px;">
          <!-- Loading Screen -->
            ...
            {if $slide.active}
               <div class="slider-content effectSlider{$slide.effect} item-slide-data-{$i+1}" data-p="225.00" style="display:none;">
                    ...
                    <div class="dor-info-perslider">
                      <div class="container">
                        <div class="dor-slider-title" data-u="caption" data-t="{if $i==0}88{else}81{/if}">{$slide.title|escape:'html':'UTF-8'}</div>
                        <div class="dor-slider-caption" data-u="caption" data-t="{if $i==0}87{else}1{/if}">{$slide.legend|escape:'html':'UTF-8'}</div>
                        ...
                        <div class="slider-read-more" data-u="caption" data-t="{if $i==0}89{else}3{/if}">
