          ...
          'title' => Context::getContext()->getTranslator()->trans('Blog Category', array(), 'Modules.smartblog'),
            ...
            'input' => array(
                array(
                    ...
                    'size' => 60,
                    'required' => true,
                    'desc' => Context::getContext()->getTranslator()->trans('Enter Your Category Name', array(), 'Modules.smartblog'),
                    'lang' => true,
                ),
                array(
                    'type' => 'textarea',
                ...
                array(
                    'type' => 'file',
                    'label' => Context::getContext()->getTranslator()->trans('Category Image:', array(), 'Modules.smartblog'),
                    'name' => 'category_image',
                    'display_image' => false,
                    'desc' => $img_desc
                ),
                array(
                    ...
                    'size' => 60,
                    'required' => false,
                    'desc' => Context::getContext()->getTranslator()->trans('Enter Your Category Meta Keyword. Separated by comma(,)', array(), 'Modules.smartblog')
                ),
                array(
                    'type' => 'textarea',
                    ...
                    'lang' => true,
                    'required' => false,
                    'desc' => Context::getContext()->getTranslator()->trans('Enter Your Category Meta Description', array(), 'Modules.smartblog')
                ),
                array(
                    'type' => 'text',
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => Context::getContext()->getTranslator()->trans('Enetr Your Category Slug. Use In SEO Friendly URL', array(), 'Modules.smartblog')
                ),
                array(
                    'type' => 'select',
                    'label' => Context::getContext()->getTranslator()->trans('Parent Category', array(), 'Modules.smartblog'),
                    'name' => 'id_parent',
                    'options' => array(
