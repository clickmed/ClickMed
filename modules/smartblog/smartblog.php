...
class smartblog extends Module {
    ...
    public function __construct(){
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = Context::getContext()->getTranslator()->trans('Smart Blog', array(), 'Modules.smartblog');
        $this->description = Context::getContext()->getTranslator()->trans('The Most Powerfull Presta shop Blog  Module - by DoradoThemes', array(), 'Modules.smartblog');
        $this->confirmUninstall = Context::getContext()->getTranslator()->trans('Are you sure you want to delete your details?', array(), 'Modules.smartblog');
    }

    public function install(){
            Configuration::updateGlobalValue('smartpostperpage', '5');
            Configuration::updateGlobalValue('limitShortDesc', 350);
            Configuration::updateGlobalValue('blogThumbListWidth', '875');
            Configuration::updateGlobalValue('blogThumbDetailWidth', '740');
            Configuration::updateGlobalValue('blogThumbListHeight', '500');
            Configuration::updateGlobalValue('blogThumbDetailHeight', '366');
            ...
            Configuration::updateGlobalValue('smartblogmetatitle', 'Dor Bolg Title'); 
            Configuration::updateGlobalValue('smartblogmetakeyword', 'Dorado Themes,blog,smartblog,prestashop blog,prestashop,blog'); 
            Configuration::updateGlobalValue('smartblogmetadescrip', 'Prestashop powerfull blog site developing module. It has hundrade of extra plugins. This module developed by doradothemes.com'); 
			$this->addquickaccess();
    ...
    public function uninstall() {
        if (!parent::uninstall() ||
            ...
            !Configuration::deleteByName('limitShortDesc') ||
            !Configuration::deleteByName('blogThumbListWidth') ||
            !Configuration::deleteByName('blogThumbListHeight') ||
            !Configuration::deleteByName('blogThumbDetailWidth') ||
            !Configuration::deleteByName('blogThumbDetailHeight') ||
    ...
    public function hookDisplayHeader($params) {
        ...
        if($checkPage == "dorblogs"){
            ...
            if(isset($dorBlogsStyle) && ($dorBlogsStyle == 3 || $dorBlogsStyle == 4 || $dorBlogsStyle == 5)){
                ...
                $this->context->controller->addJS($this->_path.'js/mainmasonry.js');
            }
        }
    }
    ...
    private function CreateSmartBlogTabs() {
                ...
                foreach($langs as $l){
                        $smarttab->name[$l['id_lang']] = Context::getContext()->getTranslator()->trans('Blog', array(), 'Modules.smartblog');
                }
                $smarttab->save();
                $tab_id = $smarttab->id;
                ...
                foreach ($tabvalue as $tab){
                    ...
                    foreach ($langs as $l) {
                        $newtab->name[$l['id_lang']] = Context::getContext()->getTranslator()->trans($tab['name'], array(), 'Modules.smartblog');
                    }
                    $newtab->save();
                }
                return true;
    ...
    public function getContent(){
                ...
                if(Tools::isSubmit('savesmartblog'))
                {
                    ...
                    Configuration::updateValue('limitShortDesc', Tools::getvalue('limitShortDesc'));
                    Configuration::updateValue('blogThumbListWidth', Tools::getvalue('blogThumbListWidth'));
                    Configuration::updateValue('blogThumbListHeight', Tools::getvalue('blogThumbListHeight'));
                    Configuration::updateValue('blogThumbDetailWidth', Tools::getvalue('blogThumbDetailWidth'));
                    Configuration::updateValue('blogThumbDetailHeight', Tools::getvalue('blogThumbDetailHeight'));
                    ...
                    $html = $this->displayConfirmation(Context::getContext()->getTranslator()->trans('The settings have been updated successfully.', array(), 'Modules.smartblog'));
            ...
            "ajax-tab.php",
            {
                ...
                elseif(Tools::isSubmit('generateimage'))
                {
                    if(Tools::getvalue('isdeleteoldthumblr') != 1)
                    {
                        ...
                        $html = $this->displayConfirmation(Context::getContext()->getTranslator()->trans('Generate New Thumblr Succesfully.', array(), 'Modules.smartblog'));
                        $helper = $this->SettingForm();
                        $html .= $helper->generateForm($this->fields_form); 
                        $helper = $this->regenerateform();
                        $html .= $helper->generateForm($this->fields_form); 
            ...
            "ajax-tab.php",
            {
                ...
                $("#smartdatasoft-content").html("<legend><img src=\'../img/admin/prestastore.gif\' class=\'middle\' />Live from SmartDataSoft Addons!</legend>"+a);
                    ...
                    else
                    {
                        ...
                        BlogImageType::ImageGenerate();
                        $html = $this->displayConfirmation(Context::getContext()->getTranslator()->trans('Delete Old Image and Generate New Thumblr Succesfully.', array(), 'Modules.smartblog'));
                        $helper = $this->SettingForm();
                        $html .= $helper->generateForm($this->fields_form); 
                        $helper = $this->regenerateform();
                        $html .= $helper->generateForm($this->fields_form); 
...
<script type="text/javascript">
    ...
    public function SettingForm() {
        ...
        $img_desc = '';
        $img_desc .= ''.Context::getContext()->getTranslator()->trans('Upload a Avatar from your computer.<br/>N.B : Only jpg image is allowed', array(), 'Modules.smartblog');
        ...
        $this->fields_form[0]['form'] = array(
          'legend' => array(
          'title' => Context::getContext()->getTranslator()->trans('Setting', array(), 'Modules.smartblog'),
            ),
            'input' => array(
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Meta Title', array(), 'Modules.smartblog'),
                ...
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Meta Keyword', array(), 'Modules.smartblog'),
                ...
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Main Blog Url', array(), 'Modules.smartblog'),
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Use .html with Friendly Url', array(), 'Modules.smartblog'),
                            'name' => 'smartusehtml',
                            'required' => false,
                            'class' => 't',
                            'is_bool' => true,
                ...
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Thumb Width Lists', array(), 'Modules.smartblog'),
                    'name' => 'blogThumbListWidth',
                    'size' => 5,
                    'default' => 875,
                    'required' => false
                ),
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Thumb Height Lists', array(), 'Modules.smartblog'),
                    'name' => 'blogThumbListHeight',
                    'size' => 5,
                    'default' => 500,
                    'required' => false
                ),
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Thumb Width Detail', array(), 'Modules.smartblog'),
                    'name' => 'blogThumbDetailWidth',
                    'size' => 5,
                    'default' => 740,
                    'required' => false
                ),
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Thumb Height Detail', array(), 'Modules.smartblog'),
                    'name' => 'blogThumbDetailHeight',
                    'size' => 5,
                    'default' => 366,
                    'required' => false
                ),
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Number of posts per page', array(), 'Modules.smartblog'),
                ...
                array(
                    'type' => 'text',
                    'label' => Context::getContext()->getTranslator()->trans('Short Description Limit Text', array(), 'Modules.smartblog'),
                    'name' => 'limitShortDesc',
                    'size' => 15,
                    'default' => 350,
                    'required' => true
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Auto accepted comment', array(), 'Modules.smartblog'),
                            ...
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Enable Captcha', array(), 'Modules.smartblog'),
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Enable Comment', array(), 'Modules.smartblog'),
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Show Author Name', array(), 'Modules.smartblog'),
                            ...
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Show Post Viewed', array(), 'Modules.smartblog'),
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Show Author Name Style', array(), 'Modules.smartblog'),
                            ...
                            'value' => 1,
                            'label' => Context::getContext()->getTranslator()->trans('First Name, Last Name', array(), 'Modules.smartblog')
                             ),
                              array(
                            'id' => 'smartshowauthorstyle',
                            'value' => 0,
                            'label' => Context::getContext()->getTranslator()->trans('Last Name, First Name', array(), 'Modules.smartblog')
                            )
                          )
                ),
                array(
                    'type' => 'file',
                    'label' => Context::getContext()->getTranslator()->trans('AVATAR Image:', array(), 'Modules.smartblog'),
                    'name' => 'avatar',
                    'display_image' => false,
                    'desc' => $img_desc
                ),
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Show No Image', array(), 'Modules.smartblog'),
                            'name' => 'smartshownoimg',
                            'required' => false,
                            'class' => 't',
                            'is_bool' => true,
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Show Category', array(), 'Modules.smartblog'),
                ...
                array(
                            'type' => 'radio',
                            'label' => Context::getContext()->getTranslator()->trans('Blog Page Column Setting', array(), 'Modules.smartblog'),
                            ...
                            'id' => 'smartshowcolumn',
                            'value' => 0,
                            'label' => Context::getContext()->getTranslator()->trans('Use Both SmartBlog Column', array(), 'Modules.smartblog')
                             ),
                             array(
                            'id' => 'smartshowcolumn',
                            'value' => 1,
                            'label' => Context::getContext()->getTranslator()->trans('Use Only SmartBlog Left Column', array(), 'Modules.smartblog')
                            ),
                            array(
                            'id' => 'smartshowcolumn',
                            'value' => 2,
                            'label' => Context::getContext()->getTranslator()->trans('Use Only SmartBlog Right Column', array(), 'Modules.smartblog')
                            ),
                            array(
                            'id' => 'smartshowcolumn',
                            'value' => 3,
                            'label' => Context::getContext()->getTranslator()->trans('Use Prestashop Column', array(), 'Modules.smartblog')
                            )
                          )
                ),
                array(
                    'type' => 'textarea',
                    'label' => Context::getContext()->getTranslator()->trans('Custom CSS', array(), 'Modules.smartblog'),
                    'name' => 'smartcustomcss',
                    'rows' => 7,
                    'cols' => 66,
                    'required' => false
        ...
        $helper->toolbar_btn = array(
            'save' =>
            array(
                'desc' => Context::getContext()->getTranslator()->trans('Save', array(), 'Modules.smartblog'),
        ...
        $helper->fields_value['limitShortDesc'] = Configuration::get('limitShortDesc');
        $helper->fields_value['blogThumbListWidth'] = Configuration::get('blogThumbListWidth');
        $helper->fields_value['blogThumbListHeight'] = Configuration::get('blogThumbListHeight');
        $helper->fields_value['blogThumbDetailWidth'] = Configuration::get('blogThumbDetailWidth');
        $helper->fields_value['blogThumbDetailHeight'] = Configuration::get('blogThumbDetailHeight');
    ...
    protected function regenerateform() {
             $default_lang = (int)Configuration::get('PS_LANG_DEFAULT');
                    $this->fields_form[0]['form'] = array(
                            'legend' => array(
                                    'title' => Context::getContext()->getTranslator()->trans('Blog Thumblr Configuration', array(), 'Modules.smartblog'),
                            ),
                            'input' => array(
                                    array(
                                        'type' => 'radio',
                                        'label' => Context::getContext()->getTranslator()->trans('Delete Old Thumblr', array(), 'Modules.smartblog'),
                        ...
                        'submit' => array(
                                        'title' => Context::getContext()->getTranslator()->trans('Re Generate Thumblr', array(), 'Modules.smartblog'),
                                        'class' => 'button'
                                        )
                    );
    ...
    public function processImageUpload($FILES) {
            if (isset($FILES['avatar']) && isset($FILES['avatar']['tmp_name']) && !empty($FILES['avatar']['tmp_name'])) {
                if ($error = ImageManager::validateUpload($FILES['avatar'], 4000000))
                    return $this->displayError(Context::getContext()->getTranslator()->trans('Invalid image', array(), 'Modules.smartblog'));
                else {
