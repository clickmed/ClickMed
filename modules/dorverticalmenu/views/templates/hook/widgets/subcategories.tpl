...
<div class="widget-subcategories block">
	...
	<div class="widget-heading title_block">
		<a href="{$link->getCategoryLink($ocategory->id_category, $ocategory->link_rewrite)|escape:'htmlall':'UTF-8'}" title="{$title|escape:'html':'UTF-8'}" class="widget-title">{$widget_heading|escape:'html':'UTF-8'}</a>
	</div>
	{/if}
	<div class="widget-inner block_content">
		<div class="widget-heading hidden"><a href="{$link->getCategoryLink($ocategory->id_category, $ocategory->link_rewrite)|escape:'htmlall':'UTF-8'}" title="{$title|escape:'html':'UTF-8'}" class="img">{$title|escape:'htmlall':'UTF-8'}</a></div>
