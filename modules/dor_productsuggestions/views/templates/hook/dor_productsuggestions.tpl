<div id="dor-product-suggestions" class="clearfix">
	<div class="dor-suggestions-tabcontent col-md-12 col-sm-12 col-xs-12 clearfix">
		<div class="dor-suggestions-wrapper">
			<div class="row-item-suggestions">
				<div class="suggestions-header">
					<h2><span class="suggestions-title"><span>{$suggestions_title}</span></span></h2>
				</div>
