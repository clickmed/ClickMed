...
<ul class="product_list grid row">
	...
	<li class="ajax_block_product js-product-miniature col-xs-12 col-sm-3" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}">
