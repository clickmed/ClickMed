...
{block name="input"}
    {if $input.type == 'link_choice'}
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function move(up)
                {
                    ...
                    if (tomove.length >1)
                    {
                        alert('{l s="Please select just one item" mod='dor_tabproductcategory_pro'}');
                        return false;
                    }
                    if (up)
	    ...
	    <div class="row hidden">
	    	<div class="col-lg-1">
	    		<h4 style="margin-top:5px;">{l s='Change position' mod='dor_tabproductcategory_pro'}</h4>
	    	...
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;">{l s='Selected items' mod='dor_tabproductcategory_pro'}</h4>
	    		{$selected_links}
	    	</div>
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;">{l s='Available items' mod='dor_tabproductcategory_pro'}</h4>
	    		{$choices}
	    	</div>
	    ...
	    <div class="row hidden">
	    	...
	    	<div class="col-lg-4"><a href="#" id="removeItem" class="btn btn-default"><i class="icon-arrow-right"></i> {l s='Remove' mod='dor_tabproductcategory_pro'}</a></div>
	    	<div class="col-lg-4"><a href="#" id="addItem" class="btn btn-default"><i class="icon-arrow-left"></i> {l s='Add' mod='dor_tabproductcategory_pro'}</a></div>
	    </div>
    {/if}
	{if $input.type =='listcatePro' }
        <div class="row">
            <div class="col-lg-6">
                <select id="list_cate" class=" fixed-width-xl" multiple="multiple" name ="pro_cate_data[]">
                    {$pro_cate_data}
                </select>
            </div>
        </div>
