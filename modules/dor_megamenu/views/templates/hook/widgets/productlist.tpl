...
<div class="widget-products block dor-menu-product-lists dorButtonArrow">
			...
			{foreach from=$products item=product name=homeFeaturedProducts}
			 ...
			 <div class="product-container clearfix">	
					...
					<div class="product-meta">
						...
						{if $product.show_price AND !isset($restricted_country_mode)}<p class="price_container"><span class="price">{if !$priceDisplay}{convertPrice price=$product.price}{else}{convertPrice price=$product.price_tax_exc}{/if}</span>
