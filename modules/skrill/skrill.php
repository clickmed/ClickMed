...
class Skrill extends PaymentModule
{
    ...
    public function hookdisplayAdminOrder()
    {
        ...
        if ($row) {
            ...
            if ($row['order_status'] == $this->failedStatus
                || $row['order_status'] == $this->refundPendingStatus
                || $row['order_status'] == $this->refundedStatus) {
    ...
    public function hookPaymentOptions($parameters)
    {
        ...
        foreach ($enabledPayments as $value) {
            ...
            $newOption->setAction($paymentController)->setLogo($logo);
