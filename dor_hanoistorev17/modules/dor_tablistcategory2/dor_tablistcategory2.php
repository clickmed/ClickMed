...
class dor_tablistcategory2 extends Module {
    private $_html = '';
    ...
    public function __construct() {
        $this->name = 'dor_tablistcategory2';
        ...
        parent::__construct();
        $this->displayName = $this->l('Dor Tab List Category 2');
        $this->description = $this->l('Dor Tab List Category 2');
    ...
    public function install() {
        ...
        $tab->name[$language['id_lang']] = $this->l('Dor Tab List Category 2');
        $tab->class_name = 'AdminDorTabListCategory2';
        $tab->id_parent = (int)Tab::getIdFromClassName('AdminDorMenu'); 
        $tab->module = $this->name;
        $tab->add();

        $today = date("Y-m-d");
        Configuration::updateValue($this->name . '_listtab_module_title2', "");
        Configuration::updateValue($this->name . '_tablist_content_custom2', "");
        Configuration::updateValue($this->name . '_tablist_show_all2', 0);
        Configuration::updateValue($this->name . '_show_latest2', 0);
        Configuration::updateValue($this->name . '_tablist_show_new2', 1);
        Configuration::updateValue($this->name . '_tablist_show_sale2', 0);
        Configuration::updateValue($this->name . '_tablist_show_feature2', 0);
        Configuration::updateValue($this->name . '_tablist_show_best2', 0);
        Configuration::updateValue($this->name . '_tablist_show_mostview2', 0);
        Configuration::updateValue($this->name . '_tablist_show_toprated2', 0);
        Configuration::updateValue($this->name . '_tablist_from_date2', "2000-01-01");
        Configuration::updateValue($this->name . '_tablist_to_date2', $today);
        Configuration::updateValue($this->name . '_tablist_show_icon2', 0);
        Configuration::updateValue($this->name . '_tablist_cate_data2', 0);
        Configuration::updateValue($this->name . '_tablist_merge_cate2', 1);
        Configuration::updateValue($this->name . '_tablist_effect2',2);
        Configuration::updateValue($this->name . '_tablist_number_product2',10);
        Configuration::updateValue($this->name . '_tablist_number_per_page2',4);
        Configuration::updateValue($this->name . '_tablist_default_tab_cate2',0);
        Configuration::updateValue($this->name . '_tablist_auto_play2',0);
        Configuration::updateValue($this->name . '_tablist_quanlity_image2',100);
        Configuration::updateValue($this->name . '_tablist_removeProductIDs2',"");
        Configuration::updateValue($this->name . '_tablist_thumb_width2',450);
        Configuration::updateValue($this->name . '_tablist_thumb_height2',450);
        return parent::install() &&
                $this->registerHook('displayHeader')
                &&
                $this->registerHook('displayBackOfficeHeader')
                && 
                $this->registerHook('tablistcategory2');
    }

    public function uninstall() {
        $today = date("Y-m-d");
        $tab = new Tab((int) Tab::getIdFromClassName('AdminDorTabListCategory2'));
        $tab->delete();
        Configuration::deleteByName($this->name . '_listtab_module_title2', "");
        Configuration::deleteByName($this->name . '_tablist_content_custom2', "");
        Configuration::deleteByName($this->name . '_tablist_show_all2', 0);
        Configuration::deleteByName($this->name . '_show_latest2', 0);
        Configuration::deleteByName($this->name . '_tablist_show_new2', 1);
        Configuration::deleteByName($this->name . '_tablist_show_sale2', 0);
        Configuration::deleteByName($this->name . '_tablist_show_feature2', 0);
        Configuration::deleteByName($this->name . '_tablist_show_best2', 0);
        Configuration::deleteByName($this->name . '_tablist_show_mostview2', 0);
        Configuration::deleteByName($this->name . '_tablist_show_toprated2', 0);
        Configuration::deleteByName($this->name . '_tablist_from_date2', "2000-01-01");
        Configuration::deleteByName($this->name . '_tablist_to_date2', $today);
        Configuration::deleteByName($this->name . '_tablist_show_icon2');
        Configuration::deleteByName($this->name . '_tablist_cate_data2');
        Configuration::deleteByName($this->name . '_tablist_merge_cate2');
        Configuration::deleteByName($this->name . '_tablist_effect2');
        Configuration::deleteByName($this->name . '_tablist_number_product2');
        Configuration::deleteByName($this->name . '_tablist_number_per_page2');
        Configuration::deleteByName($this->name . '_tablist_default_tab_cate2');
        Configuration::deleteByName($this->name . '_tablist_auto_play2');
        Configuration::deleteByName($this->name . '_tablist_quanlity_image2');
        Configuration::deleteByName($this->name . '_tablist_removeProductIDs2');
        Configuration::deleteByName($this->name . '_tablist_thumb_width2');
        Configuration::deleteByName($this->name . '_tablist_thumb_height2');
        // Uninstall Module
        if (!parent::uninstall())
            return false;
        return true;
    ...
    private function _postProcess() {
        Configuration::updateValue($this->name . '_tablist_show_all2', Tools::getValue('tablist_show_all2'));
        Configuration::updateValue($this->name . '_show_latest2', Tools::getValue('show_latest2'));
        Configuration::updateValue($this->name . '_listtab_module_title2', Tools::getValue('listtab_module_title2'));
        Configuration::updateValue($this->name . '_tablist_content_custom2', Tools::getValue('tablist_content_custom2'));
        Configuration::updateValue($this->name . '_tablist_show_new2', Tools::getValue('tablist_show_new2'));
        Configuration::updateValue($this->name . '_tablist_show_sale2', Tools::getValue('tablist_show_sale2'));
        Configuration::updateValue($this->name . '_tablist_show_feature2', Tools::getValue('tablist_show_feature2'));
        Configuration::updateValue($this->name . '_tablist_show_best2', Tools::getValue('tablist_show_best2'));
        Configuration::updateValue($this->name . '_tablist_show_mostview2', Tools::getValue('tablist_show_mostview2'));
        Configuration::updateValue($this->name . '_tablist_show_toprated2', Tools::getValue('tablist_show_toprated2'));
        Configuration::updateValue($this->name . '_tablist_from_date2', Tools::getValue('tablist_from_date2'));
        Configuration::updateValue($this->name . '_tablist_to_date2', Tools::getValue('tablist_to_date2'));
        Configuration::updateValue($this->name . '_tablist_show_icon2', Tools::getValue('tablist_show_icon2'));
        Configuration::updateValue($this->name . '_tablist_cate_data2', Tools::getValue('tablist_cate_data2'));
        Configuration::updateValue($this->name . '_tablist_merge_cate2', Tools::getValue('tablist_merge_cate2'));
        Configuration::updateValue($this->name . '_tablist_effect2', Tools::getValue('tablist_effect2'));
        Configuration::updateValue($this->name . '_tablist_number_product2', Tools::getValue('tablist_number_product2'));
        Configuration::updateValue($this->name . '_tablist_number_per_page2', Tools::getValue('tablist_number_per_page2'));
        Configuration::updateValue($this->name . '_tablist_default_tab_cate2', Tools::getValue('tablist_default_tab_cate2'));
        Configuration::updateValue($this->name . '_tablist_auto_play2', Tools::getValue('tablist_auto_play2'));
        Configuration::updateValue($this->name . '_tablist_quanlity_image2', Tools::getValue('tablist_quanlity_image2'));
        Configuration::updateValue($this->name . '_tablist_removeProductIDs2', Tools::getValue('tablist_removeProductIDs2'));
        Configuration::updateValue($this->name . '_tablist_thumb_width2', Tools::getValue('tablist_thumb_width2'));
        Configuration::updateValue($this->name . '_tablist_thumb_height2', Tools::getValue('tablist_thumb_height2'));
        $this->_html .= $this->displayConfirmation($this->l('Configuration updated'));
    }
    public function getContent() {
        $output = '<h2>' . $this->displayName . '</h2>';
        if (Tools::isSubmit('submitTabListCategory2')) {
    ...
    public  function _displayForm() {
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                       'type' => 'text',
                       'label' => 'Module Title',
                       'name' => 'listtab_module_title2',
                    ),
                    array(
                        'type' => 'switch',
                        'label' => $this->l('Show All Products:'),
                        'name' => 'tablist_show_all2',
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
                    ...
                    array(
                       ...
                       'name' => 'tablist_from_date2',
                    ),
                    array(
                       'type' => 'text',
                       'label' => 'Most View To Date:',
                       'name' => 'tablist_to_date2',
                    ),
                    
                    array(
                        'type' => 'listnew',
                        'label' => 'Select Categories:',
                        'name' => 'tablist_cate_data2',
                        'multiple'=>false,
                    ),
                    array(
                        'type' => 'text',
                        'label' => 'Default Category ID:',
                        'name' => 'tablist_default_tab_cate2',
                        'class' => 'fixed-width-md',
                    ),
                    array(
                        'type' => 'text',
                        'label' => 'Limit Products:',
                        'name' => 'tablist_number_product2',
                        'class' => 'fixed-width-md',
                    ),
                    array(
                        'type' => 'text',
                        'label' => 'Number Per Page:',
                        'name' => 'tablist_number_per_page2',
                        'class' => 'fixed-width-md',
                    ),
                    array(
                        'type' => 'select',
                        'label' => 'tablist_effect2: ',
                        'name' => 'tablist_effect2',
                        'options' => array(
                            'query' => $tablist_effect2,
                            'id' => 'id',
                            'name'=>'mode',
                        ),
                    ),
                    ...
                    array(
                        ...
                        'name' => 'tablist_removeProductIDs2',
                        'class' => 'fixed-width-md',
                    ),
                    array(
                        'type' => 'switch',
                        'label' => 'Auto play :',
                        'name' => 'tablist_auto_play2',
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
                    ...
                    array(
                        ...
                        'name' => 'tablist_quanlity_image2',
                        'class' => 'fixed-width-md',
                    ),
                    array(
                        'type' => 'text',
                        'label' => 'Thumb width image:',
                        'name' => 'tablist_thumb_width2',
                        'class' => 'fixed-width-md',
                    ),
                    array(
                        'type' => 'text',
                        'label' => 'Thumb height image:',
                        'name' => 'tablist_thumb_height2',
                        'class' => 'fixed-width-md',
                    ),
        ...
        $helper->submit_action = 'submitTabListCategory2';
        $helper->module = $this;
    ...
    {
        return array(
            'listtab_module_title2' =>     Tools::getValue('listtab_module_title2', Configuration::get($this->name . '_listtab_module_title2')),
            'tablist_content_custom2' =>     Tools::getValue('tablist_content_custom2', Configuration::get($this->name . '_tablist_content_custom2')),
            'tablist_show_all2' =>     Tools::getValue('tablist_show_all2', Configuration::get($this->name . '_tablist_show_all2')),
            'show_latest2' =>     Tools::getValue('show_latest2', Configuration::get($this->name . '_show_latest2')),
            'tablist_show_new2' =>     Tools::getValue('tablist_show_new2', Configuration::get($this->name . '_tablist_show_new2')),
            'tablist_show_sale2' =>   Tools::getValue('tablist_show_sale2', Configuration::get($this->name . '_tablist_show_sale2')),
            'tablist_show_feature2' =>     Tools::getValue('tablist_show_feature2', Configuration::get($this->name . '_tablist_show_feature2')),
            'tablist_show_best2' =>    Tools::getValue('tablist_show_best2', Configuration::get($this->name . '_tablist_show_best2')),
            'tablist_show_mostview2' =>    Tools::getValue('tablist_show_mostview2', Configuration::get($this->name . '_tablist_show_mostview2')),
            'tablist_show_toprated2' =>    Tools::getValue('tablist_show_toprated2', Configuration::get($this->name . '_tablist_show_toprated2')),
            'tablist_from_date2' =>    Tools::getValue('tablist_from_date2', Configuration::get($this->name . '_tablist_from_date2')),
            'tablist_to_date2' =>    Tools::getValue('tablist_to_date2', Configuration::get($this->name . '_tablist_to_date2')),
            'tablist_cate_data2' => Tools::getValue('tablist_cate_data2', Configuration::get($this->name . '_tablist_cate_data2')),
            'show_depth' => Tools::getValue('show_depth', Configuration::get($this->name . '_show_depth')),
            'tablist_merge_cate2' => Tools::getValue('tablist_merge_cate2', Configuration::get($this->name . '_tablist_merge_cate2')),
            'tablist_effect2' => Tools::getValue('tablist_effect2', Configuration::get($this->name . '_tablist_effect2')),
            'tablist_number_product2' => Tools::getValue('tablist_number_product2', Configuration::get($this->name . '_tablist_number_product2')),
            'tablist_number_per_page2' => Tools::getValue('tablist_number_per_page2', Configuration::get($this->name . '_tablist_number_per_page2')),
            'tablist_default_tab_cate2' => Tools::getValue('tablist_default_tab_cate2', Configuration::get($this->name . '_tablist_default_tab_cate2')),
            'tablist_auto_play2' => Tools::getValue('tablist_auto_play2', Configuration::get($this->name . '_tablist_auto_play2')),
            'tablist_quanlity_image2' => Tools::getValue('tablist_quanlity_image2', Configuration::get($this->name . '_tablist_quanlity_image2')),
            'tablist_removeProductIDs2' => Tools::getValue('tablist_removeProductIDs2', Configuration::get($this->name . '_tablist_removeProductIDs2')),
            'tablist_thumb_width2' => Tools::getValue('tablist_thumb_width2', Configuration::get($this->name . '_tablist_thumb_width2')),
            'tablist_thumb_height2' => Tools::getValue('tablist_thumb_height2', Configuration::get($this->name . '_tablist_thumb_height2')),
        );
    }
    ...
    public  function getCategoryOption($id_category = 1, $id_lang = false, $id_shop = false,$recursive = true) {
        $cate = Configuration::get($this->name . '_tablist_cate_data2');
    ...
    public function hookDisplayHeader() {
        ...
        $this->context->controller->addJS($this->_path . 'assets/js/dor_tablistcategory2.js');
    }
    public function hookDisplayBackOfficeHeader()
    {
        $this->context->controller->addCSS($this->_path . 'assets/css/dor_tablistcategory_admin.css');
        $this->context->controller->addJS($this->_path . 'assets/js/dor_tablistcategory2_admin.js');
    }
    public function hookHome(){
        ...
        $today = date("Y-m-d");
        $moduleTitle = Configuration::get($this->name . '_listtab_module_title2');
        $cateID = Configuration::get($this->name . '_tablist_cate_data2');
        $defaultTabID = Configuration::get($this->name . '_tablist_default_tab_cate2');
        $mergeCate = Configuration::get($this->name . '_tablist_merge_cate2');
        $nb = Configuration::get($this->name . '_tablist_number_product2');
        $per = Configuration::get($this->name.'_tablist_number_per_page2');
        $quanlity_image = Configuration::get($this->name.'_tablist_quanlity_image2');
        $tablist_removeProductIDs2 = Configuration::get($this->name.'_tablist_removeProductIDs2');
        $thumbWidth = Configuration::get($this->name.'_tablist_thumb_width2');
        $thumbHeight = Configuration::get($this->name.'_tablist_thumb_height2');
        $thumbWidth = (isset($thumbWidth) && $thumbWidth != "")?$thumbWidth:450;
        $thumbHeight = (isset($thumbHeight) && $thumbHeight != "")?$thumbHeight:450;
        $fromDate = Configuration::get($this->name . '_tablist_from_date2');
        $toDate = Configuration::get($this->name . '_tablist_to_date2');
        if($fromDate == ""){
            $fromDate = "2000-01-01";
        }
        if($toDate == ""){
        ...
        $contentCustom = Configuration::get($this->name . '_tablist_content_custom2');
        $cusImages = array();
        if($contentCustom != ""){
        ...
        if($defaultTabID != -1){
            $itemlists = $this->DorCacheTablist2($cateID, $defaultTabID, $defaultTabID, $productTabslider);
            $products = $itemlists;
        }else{
            $productArray = array();
            if(Configuration::get($this->name . '_tablist_show_all2')) {
        ...
        if($defaultTabID != -1){
            return $this->display(__FILE__, 'dor_tablistcategory2.tpl', $this->getCacheId()."-".$defaultTabID."-".$id_shop."-".$id_lang);
        }else{
            return $this->display(__FILE__, 'dor_tablistcategory2_all.tpl', $this->getCacheId()."-".$defaultTabID."-".$id_shop."-".$id_lang);
        }
    }

    public function DorCacheTablist2($mainCateID, $cateID,$defaultTabID, $productTabslider){
        ...
        $id_shop = (int)Context::getContext()->shop->id;
        $id_lang = Context::getContext()->language->id;
        $objCache = new DorCaches(array('name'=>'default','path'=>_PS_ROOT_DIR_.'/override/Dor/Caches/smartcaches/tablist2/','extension'=>'.cache'));
        $fileCache = 'HomeTabList2Caches-Shop'.$id_shop."-".$id_lang.'-'.$cateID.'-'.$page;
    ...
    public function hooktablistcategory2($params){
        return $this->hookHome($params);
    }
    public function clearCache()
    {
        $this->_clearCache('dor_tablistcategory2.tpl');
    }
    public function hookAjaxCall($params)
    {
        ...
        if(isset($_POST['cateID']) && $_POST['cateID'] != ""){
            ...
            $page = isset($_POST['page'])?$_POST['page']-1:0;
            $itemlists = $this->DorCacheTablist2($cateID, $_POST['cateID'], $defaultTabID=0, $productTabslider=array());
            $products = $itemlists;
