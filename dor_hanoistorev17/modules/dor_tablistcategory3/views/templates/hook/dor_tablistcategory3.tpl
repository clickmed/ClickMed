<div id="dor-tab-list-category3" class="dor-tab-list-category clearfix">
	<div class="col-lg-12 col-sm-12-col-xs-12">
		<div class="fancy-heading text-center">
	        <h3><span>{l s=$moduleTitle mod='dor_tablistcategory3'}</span></h3>
	    </div>
		<div class="dor-tab-list-category-wrapper">
			...
			{if $listTabsProduct}
				...
				<div data-aria-labelledby="cate-tab-list3-{$productTab.id}-tab" id="cate-tab-list3-{$productTab.id}" class="tab-pane fade {if $productTab.id==$tabID.id} active {/if} in">
					...
					<a href="#" class="load-more-tab dor-icon-float-away tablists3" data-page="2" data-limit="{$optionsConfig.listLimit3}" data-ajax="{if isset($urls.force_ssl) && $urls.force_ssl}{$urls.base_url_ssl}{else}{$urls.base_url}{/if}modules/dor_tablistcategory3/productcategory-ajax.php" onclick="return false">
			...
			{/if}
				...
				<div data-aria-labelledby="cate-tab-list3-{$cate.id}-tab" id="cate-tab-list3-{$cate.id}" class="tab-pane fade {if $cate.id==$tabID.id} active {/if} in">
					...
					<a href="#" class="load-more-tab dor-icon-float-away tablists3" data-page="2" data-ajax="{if isset($urls.force_ssl) && $urls.force_ssl}{$urls.base_url_ssl}{else}{$urls.base_url}{/if}modules/dor_tablistcategory3/productcategory-ajax.php" data-limit="{$optionsConfig.listLimit3}" onclick="return false">
						<span class="clt-left"></span><span class="load-center"><i class="fa fa-plus"></i></span><span class="clt-right"></span>
					</a>
				</div>
				{$key= $key+1}
