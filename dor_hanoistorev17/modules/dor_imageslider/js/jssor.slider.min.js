(function(k, f, c, j, d, l, h) { /*! Jssor */
    ...
    var b = k.$Jssor$ = new function() {
        ...
        g.$GetElement = function(a) {
            if (g.$IsString(a)) a = f.getElementById(a);
            return a
        };
        ...
        g.$EvtSrc = function(b) {
            ...
            if (a.nodeType == 3) a = g.$ParentNode(a);
            return a
        };
        ...
        g.$EnableElement = function(a, b) {
            if (b) g.$Attribute(a, "disabled", d);
            else g.$RemoveAttribute(a, "disabled")
        };
        g.$HideElements = function(b) {
            for (var a = 0; a < b.length; a++) g.$HideElement(b[a])
        };
        g.$ShowElement = function(a, b) {
            g.$CssDisplay(a, b ? "none" : "")
        };
        g.$ShowElements = function(b, c) {
            for (var a = 0; a < b.length; a++) g.$ShowElement(b[a], c)
        };
        ...
        function w(f, l) {
            ...
            w = function(e, c) {
                ...
                if (c.$Transform)
                    if (d) yb(g.$CreateCallback(j, P, e, c));
                    else a(e, c)
            };
            g.$SetStyleTransform = P;
            if (d) g.$SetStyleTransform = w;
            if (e) g.$SetStyleTransform = a;
            else if (!b) a = P;
            g.$SetStyles = w;
            w(f, l)
        }
    ...
    var i = k.$JssorSlider$ = function(p, hc) {
        ...
        var widthSlider = jQuery(document).width();
        /*jQuery("#Dor_Full_Slider").css("height",heightSlider);
        jQuery(".dor-slider-content").css("height",heightSlider);
        jQuery(".dor-slider-content").css("width",widthSlider);*/
        function Fc() {
            var a = this;
            m.call(a, -1e8, 2e8);
        ...
        function Bc(k, f) {
            ...
            function S(d, g, l) {
                if (d == f) {
                    if (d != g) C[g] && C[g].$ParkOut();
                    else !l && h && h.$AdjustIdleOnPark();
                    p && p.$Enable();
                    var m = R = b.$GetNow();
