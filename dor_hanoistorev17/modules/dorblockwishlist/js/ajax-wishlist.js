...
$(document).ready(function(){
	...
	jQuery(".addToDorWishlist").click(function(){
		var id = 0;
		var id_wishlist = 0;
		var quantity = 1;
		var action = "add";
...
function DeleteWishlistItem(){
	jQuery(".remove-wishlist-item").click(function(){
		...
		var id_product_attribute = jQuery(this).closest(".js-product-miniature").attr("data-id-product-attribute");
		WishlistCart(id, action, id_product, id_product_attribute, quantity, id_wishlist);
		jQuery(this).closest(".js-product-miniature").remove();
	});
}
...
function WishlistCart(id, action, id_product, id_product_attribute, quantity, id_wishlist)
{
	$.ajax({
		type: 'GET',
		url: prestashop.urls.base_url+ 'modules/dorblockwishlist/cart.php?rand=' + new Date().getTime(),
		...
		success: function(data)
		{
			if (action == 'add')
			{
				if (prestashop.customer.is_logged == true) {
					...
					wishlistRefreshStatus();
					WishlistPop("The product was successfully added to your wishlist.");
				}
				else
				{
					WishlistPop("You must be logged in to manage your wishlist.");
				}
			}
			if (action == 'delete') {
