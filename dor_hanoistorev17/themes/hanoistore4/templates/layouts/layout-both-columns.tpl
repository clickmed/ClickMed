  ...
  <body id="{$page.page_name}" class="{$page.body_classes|classnames} dor-list-effect-pizza2 {if isset($dorDetailCols) && $dorDetailCols != ''}{$dorDetailCols}{/if} {if isset($dorCategoryEffect) && $dorCategoryEffect != ''}dorHoverEffect{$dorCategoryEffect}{/if}">
    ...
    <main{if isset($dorlayoutmode) && $dorlayoutmode != ""} class="{$dorlayoutmode}"{/if}>
      ...
      {if $page.page_name == 'index'}
        ...
        {if $smarty.capture.dorDailyDeal || $smarty.capture.dorTabProductCate}
      ...
      {/if}
      {if $page.page_name == 'index'}
        {capture name='dorTabProductCate2'}{hook h='dorTabProductCate2'}{/capture}
        {if $smarty.capture.dorTabProductCate2}
          <div class="dorTabProductCate2 blockPosition dor-bg-white">
            <div class="container">
              <div class="row">
              {$smarty.capture.dorTabProductCate2 nofilter}
              </div>
            </div>
          </div>
        {/if}
        {capture name='blockDorado6'}{hook h='blockDorado6'}{/capture}
          {if $smarty.capture.blockDorado6}
            <div class="blockDorado6 blockPosition dor-bg-white">
              <div class="container">
                <div class="row">
                {$smarty.capture.blockDorado6 nofilter}
                </div>
              </div>
            </div>
          {/if}
      ...
      {if $page.page_name == 'index'}
        ...
        {if $smarty.capture.DorTabPro || $smarty.capture.DorTestimonial}
          <div class="blockDorGroup blockPosition dor-bg-white">
            <div class="container">
              <div class="row">
      ...
      {if $page.page_name == 'index'}
          ...
          {if $smarty.capture.dorAjaxTabPro3}
            <div class="dorAjaxTabPro3 blockPosition dor-bg-white">
              <div class="container">
                <div class="row">
