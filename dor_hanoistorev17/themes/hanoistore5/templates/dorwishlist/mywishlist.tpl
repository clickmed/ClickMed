...
<div id="content-wrapper" class="right-column col-xs-12 col-sm-8 col-md-9 pull-right">
	<div id="mywishlist">
		<section id="products">
		<h1 class="h1 hidden">{l s='My wishlists' mod='dorblockwishlist'}</h1>
		<h2 class="hidden">{l s='My wishlists' mod='dorblockwishlist'}</h2>
			...
			<div id="block-order-detail">
			    ...
			    {foreach from=$products item="product"}
			      <article class="product-miniature js-product-miniature ajax_block_product col-xs-12 col-sm-6 col-md-4" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
			      	<span class="remove-wishlist-item" title="{l s='Delete' mod='dorblockwishlist'}"><i class="material-icons">highlight_off</i><span class="remove-wishlist-txt">{l s='Delete' mod='dorblockwishlist'}</span></span>
