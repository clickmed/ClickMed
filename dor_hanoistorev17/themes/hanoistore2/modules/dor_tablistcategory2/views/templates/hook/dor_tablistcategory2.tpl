	...
	<div class="col-lg-12 col-sm-12-col-xs-12">
		<div class="dor-tab-list-category-wrapper">
			<div class="head-tab-lists">
				<h3>{l s=$moduleTitle mod='dor_tablistcategory2'} <i aria-hidden="true" class="fa fa-bars"></i></h3>
			...
			{if $listTabsProduct}
				...
				{$k=0}
				{foreach from=$listTabsProduct item=productTab name=tabCatePro}
				<div data-aria-labelledby="cate-tab-list2-{$productTab.id}-tab" id="cate-tab-list2-{$productTab.id}" class="tab-pane fade {if $productTab.id==$tabID.id} active {/if} in dorButtonArrow">
					...
					<a href="#" class="load-more-tab dor-icon-float-away tablists2" data-page="2" data-limit="" data-ajax="{if isset($urls.force_ssl) && $urls.force_ssl}{$urls.base_url_ssl}{else}{$urls.base_url}{/if}modules/dor_tablistcategory2/productcategory-ajax.php" onclick="return false">
			...
			{/if}
				...
				<div data-aria-labelledby="cate-tab-list2-{$cate.id}-tab" id="cate-tab-list2-{$cate.id}" class="tab-pane fade {if $cate.id==$tabID.id} active {/if} in">
					...
					<a href="#" class="load-more-tab dor-icon-float-away tablists2" data-page="2" data-ajax="{if isset($urls.force_ssl) && $urls.force_ssl}{$urls.base_url_ssl}{else}{$urls.base_url}{/if}modules/dor_tablistcategory2/productcategory-ajax.php" data-limit="" onclick="return false">
						<span class="clt-left"></span><span class="load-center"><i class="fa fa-plus"></i></span><span class="clt-right"></span>
					</a>
				</div>
				{$key= $key+1}
