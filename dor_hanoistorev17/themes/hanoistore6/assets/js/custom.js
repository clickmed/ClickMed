...
var DORTHEME = {
	...
	init:function(){
		...
		DORTHEME.FeaturedCarousel();
		DORTHEME.NewProductCarousel();
		DORTHEME.SuggestionsCarousel();
		DORTHEME.Testimonials();
	...
	TopbarMobile:function(){
		...
		jQuery(".dot-topbar-account > i").click(function(){
			var check = jQuery(".dot-topbar-account").hasClass("open");
			if(check){
				jQuery(".dot-topbar-account").removeClass("open");
			}else{
				jQuery(".dot-topbar-account").addClass("open");
			}
		});
		jQuery(document).click(function (event) {
            ...
            if (!jQuery(event.target).is(".dot-topbar-account > i, .dot-topbar-account, .dot-topbar-account *")) {
                jQuery(".dot-topbar-account").removeClass("open");
            }
        });
	},
