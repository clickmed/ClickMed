...
class FrontControllerCore extends Controller
{
    ...
    public function getLayout()
    {
        ...
        $layoutDetail = Configuration::get('dor_themeoptions_dorDetailCols');
        ...
        if($entity == "product" && isset($layoutDetail) && $layoutDetail == "proDetailCol3"){
            $layout = 'layouts/dorlayout-left-column.tpl';
        }
        if($entity == "product" && isset($layoutDetail) && $layoutDetail == "proDetailCol2"){
            $layout = 'layouts/dorlayout-right-column.tpl';
        }
        if($entity == "product" && isset($layoutDetail) && $layoutDetail == "proDetailCol1"){
